...
- The result is `EXECUTABLE_SE_SYNTHESIS_SUPPORTED` with Gate 1 `PASS`, bounded to the self-authored protocol and recorded interpretations; it is not production correctness or formal verification.
